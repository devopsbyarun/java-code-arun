...
public class HelloWorldController {
     ...
     */
    public HelloWorldController(){<!DOCTYPE html>
<html>
...
.bgimg-1 {
   background-position: center;
	...
	background-image: linear-gradient(white 10%,cyan 20%,#4d4dff);
	font-size: 24px;
    min-height: 100%;
}
...
<header class="bgimg-1 w3-display-container" id="home">
  <div class="w3-display-left" style="padding:48px">
    <span class="w3-jumbo w3-hide-small">Welcome to DevOps with AWS V5</span><br>
